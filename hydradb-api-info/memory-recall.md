...
> Hybrid search over user memories only. Use this when you need context from stored user preferences, conversations, or behavioral memories.
...
````yaml POST /recall/recall_preferences
openapi: 3.1.0
info:
  title: HydraDB API
